    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-20 flex flex-col items-center">
      {user && (
        <div className="animate-fade-in-up mb-4">
          <span className="inline-block text-xl md:text-2xl font-bold font-['Montserrat'] tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-[#ffd700] to-[#e8b34b] drop-shadow-[0_0_15px_rgba(232,179,75,0.6)]">
      ...
      <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-['Montserrat'] mb-6 animate-fade-in-up stagger-1 leading-[1.1] text-white drop-shadow-lg">
        Master the
        <br />
        <span className="text-gold-gradient">Game of Intelligence</span>
      </h1>
      
      <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 animate-fade-in-up stagger-2 drop-shadow-md">
        Play, analyze, and dominate with next-level chess technology. Experience the future of chess with AI-powered insights and global multiplayer.
      </p>
      
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up stagger-3">
        <button 
          onClick={() => navigate('/play')}
          className="btn-gold px-8 py-4 rounded-full text-base font-semibold flex items-center gap-2 group hover:-translate-y-1 transition-transform cursor-pointer"
        >
        ...
        <button 
          ...
          className="btn-outline px-8 py-4 rounded-full text-base font-semibold flex items-center gap-2 cursor-pointer"
        >
